/**
 * \file tests/test_graph_three_edges_2strand_inverted.cpp
 * \brief Unit tests for graph three edges 2-strand inverted.
 */
...
int main()
{
    ...
    Edge_2Strand_Inverted inv_type;
    ...
    e3.set_style(Edge_Style(24, 10, 0.5, &inv_type, Edge_Style::EVERYTHING, 10, 1));
    g.render_knot();
