...
Snapping_Grid::Snapping_Grid(unsigned size, Snapping_Grid::Grid_Shape shape, QPointF origin,
                             bool enabled)
    : m_size(size > 0 ? size : 1), m_shape(shape), m_origin(origin), m_enabled(enabled)
{
}
