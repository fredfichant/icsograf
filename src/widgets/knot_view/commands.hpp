...
class Knot_Macro : public Knot_Command
{
   ...
   public:
    Knot_Macro(QString text, Knot_View* kv, Knot_Macro* parent = nullptr) : Knot_Command(kv, parent)
    {
        setText(text);
    }
    void undo() override;
...
class Last_Node : public Knot_Command
{
   ...
   public:
    Last_Node(Node* node_before, Node* node_after, Knot_View* kv, Knot_Macro* parent = nullptr);
    void undo() override;
    void redo() override;
};
...
class Knot_Style_All : public Knot_Command
{
   ...
   public:
    Knot_Style_All(Node_Style node_before, Node_Style node_after, Edge_Style edge_before,
                   Edge_Style edge_after, Knot_View* kv, Knot_Macro* parent = nullptr);
    void undo() override;
    void redo() override;
};
...
class Knot_Style_Spacing : public Knot_Style_Basic_Double_Parameter
{
    Q_OBJECT
   ...
   public:
    Knot_Style_Spacing(double before, double after, Knot_View* kv, Knot_Macro* parent = nullptr)
        : Knot_Style_Basic_Double_Parameter(before, after, kv, parent)
    {
        setText(tr("Change Strands Spacing"));
    }
...
class Knot_Style_Strand_Count : public Knot_Style_Basic_Double_Parameter
{
    Q_OBJECT
   ...
   public:
    Knot_Style_Strand_Count(int before, int after, Knot_View* kv, Knot_Macro* parent = nullptr)
        : Knot_Style_Basic_Double_Parameter(before, after, kv, parent)
    {
        setText(tr("Change Strand Count"));
    }
...
class Knot_Style_Edge_Slide : public Knot_Style_Basic_Double_Parameter
{
   ...
   public:
    Knot_Style_Edge_Slide(double before, double after, Knot_View* kv, Knot_Macro* parent = nullptr)
        : Knot_Style_Basic_Double_Parameter(before, after, kv, parent)
    {
...
class Knot_Style_Cusp_Angle : public Knot_Style_Basic_Double_Parameter
{
   ...
   public:
    Knot_Style_Cusp_Angle(double before, double after, Knot_View* kv, Knot_Macro* parent = nullptr)
        : Knot_Style_Basic_Double_Parameter(before, after, kv, parent)
    {
...
class Node_Style_Base : public Knot_Command
{
   ...
   public:
    Node_Style_Base(QList<Node*> nodes, Knot_View* kv, Knot_Macro* parent = nullptr);
};
/**
...
class Node_Style_Basic_Double_Parameter : public Node_Style_Base
{
   ...
   public:
    Node_Style_Basic_Double_Parameter(QList<Node*> nodes, QList<double> before, QList<double> after,
...
class Node_Style_Handle_Lenght : public Node_Style_Basic_Double_Parameter
{
   ...
   public:
    Node_Style_Handle_Lenght(QList<Node*> nodes, QList<double> before, QList<double> after,
                             Knot_View* kv, Knot_Macro* parent = nullptr)
...
class Node_Style_Cusp_Distance : public Node_Style_Basic_Double_Parameter
{
   ...
   public:
    Node_Style_Cusp_Distance(QList<Node*> nodes, QList<double> before, QList<double> after,
                             Knot_View* kv, Knot_Macro* parent = nullptr)
        : Node_Style_Basic_Double_Parameter(nodes, before, after, kv, parent)
    {
...
class Node_Style_Cusp_Angle : public Node_Style_Basic_Double_Parameter
{
   ...
   public:
    Node_Style_Cusp_Angle(QList<Node*> nodes, QList<double> before, QList<double> after,
                          Knot_View* kv, Knot_Macro* parent = nullptr)
        : Node_Style_Basic_Double_Parameter(nodes, before, after, kv, parent)
    {
...
class Node_Style_Cusp_Shape : public Node_Style_Base
{
   ...
   public:
    Node_Style_Cusp_Shape(QList<Node*> nodes, QList<Cusp_Shape*> before, QList<Cusp_Shape*> after,
                          Knot_View* kv, Knot_Macro* parent = nullptr);
    void undo() override;
    void redo() override;
};
...
class Node_Style_Enable : public Node_Style_Base
{
   ...
   public:
    Node_Style_Enable(QList<Node*> nodes, QList<Node_Style::Enabled_Styles> before,
                      QList<Node_Style::Enabled_Styles> after, Knot_View* kv,
                      Knot_Macro* parent = nullptr);
    Node_Style_Enable(Node* node, Node_Style::Enabled_Styles before,
...
class Edge_Style_Base : public Knot_Command
{
   ...
   public:
    Edge_Style_Base(QList<Edge*> edges, Knot_View* kv, Knot_Macro* parent = nullptr);
};
/**
 *  \brief Base class for selection (edges) style commands
 *
...
class Edge_Style_Basic_Double_Parameter : public Edge_Style_Base
{
   ...
   public:
    Edge_Style_Basic_Double_Parameter(QList<Edge*> nodes, QList<double> before, QList<double> after,
                                      Knot_View* kv, Knot_Macro* parent = nullptr);
    void undo() override;
    void redo() override;
    bool mergeWith(const QUndoCommand* other) override;
...
class Edge_Style_Crossing_Distance : public Edge_Style_Basic_Double_Parameter
{
   ...
   public:
    Edge_Style_Crossing_Distance(QList<Edge*> edges, QList<double> before, QList<double> after,
                                 Knot_View* kv, Knot_Macro* parent = nullptr)
...
class Edge_Style_Spacing : public Edge_Style_Basic_Double_Parameter
{
    Q_OBJECT
   ...
   public:
    Edge_Style_Spacing(QList<Edge*> edges, QList<double> before, QList<double> after, Knot_View* kv,
                       Knot_Macro* parent = nullptr)
        : Edge_Style_Basic_Double_Parameter(edges, before, after, kv, parent)
    {
        setText(tr("Change Selection Strands Spacing"));
    }
...
class Edge_Style_Strand_Count : public Edge_Style_Basic_Double_Parameter
{
    Q_OBJECT
   ...
   public:
    Edge_Style_Strand_Count(QList<Edge*> edges, QList<double> before, QList<double> after,
                            Knot_View* kv, Knot_Macro* parent = nullptr)
        : Edge_Style_Basic_Double_Parameter(edges, before, after, kv, parent)
    {
        setText(tr("Change Selection Strand Count"));
    }
...
class Edge_Style_Edge_Slide : public Edge_Style_Basic_Double_Parameter
{
   ...
   public:
    Edge_Style_Edge_Slide(QList<Edge*> edges, QList<double> before, QList<double> after,
                          Knot_View* kv, Knot_Macro* parent = nullptr)
        : Edge_Style_Basic_Double_Parameter(edges, before, after, kv, parent)
    {
...
class Change_Edge_Type : public Knot_Command
{
   ...
   public:
    Change_Edge_Type(Edge* edge, Edge_Type* before, Edge_Type* after, Knot_View* kv,
                     Knot_Macro* parent = nullptr);
    void undo() override;
    void redo() override;
    int id() const override { return m_id; }
...
class Edge_Style_Enable : public Edge_Style_Base
{
   ...
   public:
    Edge_Style_Enable(QList<Edge*> edges, QList<Edge_Style::Enabled_Styles> before,
                      QList<Edge_Style::Enabled_Styles> after, Knot_View* kv,
                      Knot_Macro* parent = nullptr);
    Edge_Style_Enable(Edge* edges, Edge_Style::Enabled_Styles before,
...
class Edge_Style_Handle_Lenght : public Edge_Style_Basic_Double_Parameter
{
   ...
   public:
    Edge_Style_Handle_Lenght(QList<Edge*> edges, QList<double> before, QList<double> after,
                             Knot_View* kv, Knot_Macro* parent = nullptr)
        : Edge_Style_Basic_Double_Parameter(edges, before, after, kv, parent)
    {
